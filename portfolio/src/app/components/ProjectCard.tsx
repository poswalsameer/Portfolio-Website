...
function ProjectCard(props: {
  ...
  return (
    ...
    2xl:flex 2xl:flex-col 2xl:rounded-xl  ' >
        ...
        <div className='
        p-4 flex flex-col bg-[#c3a995] h-28 w-[15rem] rounded-r-lg
        sm:p-4 sm:flex sm:flex-col sm:bg-[#c3a995] sm:h-40 sm:w-[24rem] sm:rounded-r-xl
        ...
        2xl:p-4 2xl:flex 2xl:flex-col 2xl:justify-center 2xl:items-center 2xl:bg-[#c3a995] 2xl:h-56 2xl:w-[24rem] 2xl:rounded-b-xl' >
            ...
            <h1 className='
            mt-0 text-[#0c1821] text-center text-xl font-extrabold
            ...
            2xl:mt-2 2xl:text-[#0c1821] 2xl:text-3xl 2xl:font-extrabold'>
              {props.projectName}
            </h1>

            <h1 className='
            h-40 w-full my-1 text-center text-[#6f5e53] font-bold text-[0.5rem]
            ...
            2xl:h-44 2xl:w-full 2xl:my-5 2xl:text-center 2xl:text-[#6f5e53] 2xl:font-bold 2xl:text-sm '>
              {props.techUsed}
            </h1>

            <div className='
            w-full my-0 flex flex-row justify-between 
            ...
            2xl:w-full 2xl:my-1 2xl:flex 2xl:flex-row 2xl:justify-between'>
                ...
                className='
                mb-0 mx-8 bg-[#ab947e] p-1 rounded-[0.25rem] border-2 border-[#ab947e] hover:border-2 hover:border-[#4a4036] hover:cursor-none
