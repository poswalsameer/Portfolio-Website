...
function ProjectCard(props: {
  ...
  return (
    ...
    <div className='xl:flex xl:flex-col xl:rounded-xl xl:transition-all xl:ease-in xl:hover:scale-105
    
    2xl:flex 2xl:flex-col 2xl:rounded-xl 2xl:transition-all 2xl:ease-in 2xl:hover:scale-105 ' >

        <div>
          <img src={props.projectImage} alt="" className='xl:h-72 xl:w-[24rem] xl:rounded-t-xl
          
          2xl:h-72 2xl:w-[24rem] 2xl:rounded-t-xl' />
        </div>
        
        <div className='xl:p-4 xl:flex xl:flex-col xl:justify-center xl:items-center xl:bg-[#c3a995] xl:h-56 xl:w-[24rem] xl:rounded-b-xl
        
        2xl:p-4 2xl:flex 2xl:flex-col 2xl:justify-center 2xl:items-center 2xl:bg-[#c3a995] 2xl:h-56 2xl:w-[24rem] 2xl:rounded-b-xl' >

            <h1 className='xl:my-2 xl:text-[#0c1821] xl:text-3xl xl:font-extrabold
            
            2xl:my-2 2xl:text-[#0c1821] 2xl:text-3xl 2xl:font-extrabold'>{props.projectName}</h1>

            <h1 className='xl:h-44 xl:w-full xl:my-5 xl:text-center xl:text-[#6f5e53] xl:font-bold xl:text-sm
            
            2xl:h-44 2xl:w-full 2xl:my-5 2xl:text-center 2xl:text-[#6f5e53] 2xl:font-bold 2xl:text-sm '>{props.techUsed}</h1>

            <div className='xl:w-full xl:my-1 xl:flex xl:flex-row xl:justify-between 
            
            2xl:w-full 2xl:my-1 2xl:flex 2xl:flex-row 2xl:justify-between'>

                <a href={props.liveLink} target="_blank" className='xl:mx-8 xl:bg-[#ab947e] xl:p-2 xl:rounded-lg xl:border-2 xl:border-[#ab947e] xl:hover:border-2 xl:hover:border-[#4a4036] xl:hover:cursor-none
                ...
                <a href={props.github} target="_blank" className='xl:mx-8 xl:bg-[#ab947e] xl:p-2 xl:rounded-lg xl:border-2 xl:border-[#ab947e] xl:hover:border-2 xl:hover:border-[#4a4036] xl:hover:cursor-none
