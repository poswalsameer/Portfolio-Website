    ...
    <div className='flex flex-col border-2 border-[#fefae0] rounded-xl' >
        ...
        <div className='p-4 flex flex-col justify-center items-center bg-[#c3a995] h-56 w-[24rem] rounded-b-xl' >
            ...
            <div className=' w-full my-1 flex flex-row justify-between'>
                <a href={props.liveLink} target="_blank" className='mx-8 bg-[#ab947e] p-2 rounded-lg border-2 border-[#ab947e] hover:border-2 hover:border-[#4a4036] ' > 
                ...
                <a href={props.github} target="_blank" className='mx-8 bg-[#ab947e] p-2 rounded-lg border-2 border-[#ab947e] hover:border-2 hover:border-[#4a4036] ' > 
