...
function Header() {
  return (
    <>
      ...
      md:fixed md:top-0 md:z-10 md:h-12 md:w-full md:flex md:flex-row md:justify-center md:items-center md:bg-[#cbbdaf] 
      
      lg:fixed lg:top-0 lg:z-10 lg:h-12 lg:w-full lg:flex lg:flex-row lg:justify-center lg:items-center lg:bg-[#cbbdaf] 
      ...
      2xl:fixed 2xl:top-0 2xl:z-10 2xl:h-12 2xl:w-full 2xl:flex 2xl:flex-row 2xl:justify-center 2xl:items-center 2xl:bg-[#cbbdaf] ' >
        ...
        <p className='md:mx-4 md:text-sm md:font-bold md:text-[#0a0908]
        
        lg:mx-12 lg:text-base lg:font-bold lg:text-[#0a0908]
        ...
        <p className='md:mx-8 md:text-sm md:font-bold md:text-[#0a0908]
