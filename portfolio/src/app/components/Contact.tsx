  ...
  return (
    <div className='mt-10 text-white flex flex-col justify-center items-center'>
        ...
        <div className=' my-5 flex flex-col justify-center items-center'>
            <p>You can always contact me to discuss about tech, games, emulation, sports, and for any hiring related talk too!</p>

            <p>Here's my contact number and email address: </p>
        </div>
        ...
        <div className=' my-5 flex flex-row w-full justify-center items-center'>
            ...
            <div className='flex flex-row'>
                ...
                <p className='mx-3'> poswalsameer2003@gmail.com</p>
            </div>

        </div>

        <div className=' my-5 flex flex-col justify-center items-center'>
            <p>Feel free to reach out to me using these details or by the social links attached in the upper section</p>
