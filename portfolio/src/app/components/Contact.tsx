...
function Contact() {
  return (
    ...
    <h1 className='xl:text-5xl xl:font-bold xl:mx-16 xl:mt-28 xl:mb-5 xl:text-[#fefae0]
    
    2xl:text-5xl 2xl:font-bold 2xl:mx-16 2xl:mt-28 2xl:mb-5 2xl:text-[#fefae0]' id='contact'>
        &lt;CONTACT /&gt;
    </h1>

    <div className='xl:mt-14 xl:py-10 xl:mx-20 xl:bg-[#322c24] xl:rounded-xl xl:p-5 xl:text-white xl:text-lg xl:flex xl:flex-col xl:justify-center xl:items-center
    ...
    2xl:mt-14 2xl:py-10 2xl:mx-20 2xl:bg-[#322c24] 2xl:rounded-xl 2xl:p-5 2xl:text-white 2xl:text-lg 2xl:flex 2xl:flex-col 2xl:justify-center 2xl:items-center' >
        ...
        <div className='xl:my-5 xl:flex xl:flex-col xl:justify-center xl:items-center 
        ...
        <div className='xl:my-5 xl:flex xl:flex-row xl:w-full xl:justify-center xl:items-center 
        
        2xl:my-5 2xl:flex 2xl:flex-row 2xl:w-full 2xl:justify-center 2xl:items-center '>
            
            <div className='xl:bg-[#faf5f0] xl:text-[#1e1b17] xl:text-sm xl:flex xl:flex-row xl:mr-3 xl:p-2 xl:justify-center xl:items-center xl:font-bold xl:w-[20%] xl:rounded-xl xl:transition-all xl:ease-in xl:hover:scale-105
            ...
            2xl:bg-[#faf5f0] 2xl:text-[#1e1b17] 2xl:text-sm 2xl:flex 2xl:flex-row 2xl:mr-3 2xl:p-2 2xl:justify-center 2xl:items-center 2xl:font-bold 2xl:w-[20%] 2xl:rounded-xl 2xl:transition-all 2xl:ease-in 2xl:hover:scale-105'>
                ...
                <p className='xl:mx-3 2xl:mx-3'>
                    7982108619 
                </p>
            </div>

            <div className='xl:bg-[#faf5f0] xl:text-[#1e1b17] xl:text-sm xl:flex xl:flex-row xl:justify-center xl:items-center xl:ml-3 xl:p-2 xl:rounded-xl xl:font-bold xl:transition-all xl:ease-in xl:hover:scale-105
