...
function Contact() {
  return (
    ...
    <h1 className='md:text-4xl md:font-bold md:mx-16 md:mt-28 md:mb-5 md:text-[#fefae0]
    
    lg:text-5xl lg:font-bold lg:mx-16 lg:mt-28 lg:mb-5 lg:text-[#fefae0]
    
    xl:text-5xl xl:font-bold xl:mx-16 xl:mt-28 xl:mb-5 xl:text-[#fefae0]
    
    2xl:text-5xl 2xl:font-bold 2xl:mx-16 2xl:mt-28 2xl:mb-5 2xl:text-[#fefae0]' id='contact'>
        &lt;CONTACT /&gt;
    </h1>

    <div className='md:mt-14 md:py-10 md:mx-20 md:bg-[#322c24] md:rounded-xl md:p-5 md:text-white md:text-lg md:flex md:flex-col md:justify-center md:items-center
    
    lg:mt-14 lg:py-10 lg:mx-20 lg:bg-[#322c24] lg:rounded-xl lg:p-5 lg:text-white lg:text-lg lg:flex lg:flex-col lg:justify-center lg:items-center
    
    xl:mt-14 xl:py-10 xl:mx-20 xl:bg-[#322c24] xl:rounded-xl xl:p-5 xl:text-white xl:text-lg xl:flex xl:flex-col xl:justify-center xl:items-center
    
    2xl:mt-14 2xl:py-10 2xl:mx-20 2xl:bg-[#322c24] 2xl:rounded-xl 2xl:p-5 2xl:text-white 2xl:text-lg 2xl:flex 2xl:flex-col 2xl:justify-center 2xl:items-center' >
        ...
        <div className='md:my-5 md:flex md:flex-row md:w-full md:justify-center md:items-center
        ...
        2xl:my-5 2xl:flex 2xl:flex-row 2xl:w-full 2xl:justify-center 2xl:items-center '>
            ...
            <div className='md:bg-[#faf5f0] md:text-[#1e1b17] md:text-sm md:flex md:flex-row md:mr-3 md:p-2 md:justify-center md:items-center md:font-bold md:w-[30%] md:rounded-lg md:transition-all md:ease-in md:hover:scale-105
            ...
            2xl:bg-[#faf5f0] 2xl:text-[#1e1b17] 2xl:text-sm 2xl:flex 2xl:flex-row 2xl:mr-3 2xl:p-2 2xl:justify-center 2xl:items-center 2xl:font-bold 2xl:w-[20%] 2xl:rounded-xl 2xl:transition-all 2xl:ease-in 2xl:hover:scale-105'>
                ...
                <p className='md:mx-3 lg:mx-3 xl:mx-3 2xl:mx-3'>
                    7982108619 
                </p>
            </div>

            <div className='md:bg-[#faf5f0] md:text-[#1e1b17] md:text-sm md:flex md:flex-row md:justify-center md:items-center md:ml-3 md:p-2 md:rounded-lg md:font-bold md:transition-all md:ease-in md:hover:scale-105
