  ...
  return (
    ...
    <div className='mt-14 py-10 mx-20 bg-[#322c24] rounded-xl p-5 text-white text-lg flex flex-col justify-center items-center' >
        ...
        <div className=' my-5 flex flex-col justify-center items-center'>
            <p>
                YOU CAN ALWAYS CONNECT WITH ME TO DISCUSS ABOUT TECH, GAMES, EMULATION, AND FOR RANDOM CHAT TOO!
            </p>
        ...
        <div className=' my-5 flex flex-row w-full justify-center items-center '>
            ...
            <div className='bg-[#faf5f0] text-[#1e1b17] text-sm flex flex-row mr-3 p-2 justify-center items-center font-bold w-[20%] rounded-xl transition-all ease-in hover:cursor-pointer hover:scale-105'>
            ...
            <div className='bg-[#faf5f0] text-[#1e1b17] text-sm flex flex-row justify-center items-center ml-3 p-2 rounded-xl font-bold transition-all ease-in hover:cursor-pointer hover:scale-105'>
