...
function Contact() {
  return (
    ...
    <h1 className='
    text-2xl font-bold mx-4 mt-0 mb-10 text-[#fefae0]
    ...
    <div className='
    mt-0 py-10 mx-6 bg-[#322c24] rounded-xl p-5 text-white text-lg flex flex-col justify-center items-center    
    sm:mt-0 sm:py-10 sm:mx-14 sm:bg-[#322c24] sm:rounded-xl sm:p-5 sm:text-white sm:text-lg sm:flex sm:flex-col sm:justify-center sm:items-center
    md:mt-14 md:py-10 md:mx-20 md:bg-[#322c24] md:rounded-xl md:p-5 md:text-white md:text-lg md:flex md:flex-col md:justify-center md:items-center
