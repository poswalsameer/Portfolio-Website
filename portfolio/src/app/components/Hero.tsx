...
function Hero() {
  ...
  return (
    <div className='xl:mt-32 xl:flex xl:flex-row xl:justify-center xl:items-center 
    ...
    2xl:mt-32 2xl:flex 2xl:flex-row 2xl:justify-center 2xl:items-center ' id='home'>
        ...
        2xl:flex 2xl:flex-col 2xl:justify-center 2xl:items-center ' >
            ...
            <h1 className='xl:text-8xl xl:text-[#faf5f0] xl:font-extrabold xl:my-6
            ...
            <div className='xl:flex xl:flex-row xl:text-5xl xl:text-[#c3a995] xl:font-semibold xl:my-3
            
            2xl:flex 2xl:flex-row 2xl:text-5xl 2xl:text-[#c3a995] 2xl:font-semibold 2xl:my-3 ' >

                <h1 className='xl:absolute xl:-ml-[18%] xl:text-[#c3a995]
                ...
                <h1 className='xl:absolute xl:ml-[0%]
            ...
            <div className='xl:flex xl:flex-row xl:mt-20
            
            2xl:flex 2xl:flex-row 2xl:mt-20' >

                <a href="https://github.com/poswalsameer" target="_blank"><img src="github.png" alt="" className='xl:bg-[#f0e2d3] xl:p-2 xl:rounded-xl xl:h-12 xl:w-12 xl:border-2 xl:border-[#f0e2d3] xl:transition-all xl:ease-in xl:delay-75 xl:hover:scale-110 xl:hover:cursor-none xl:mx-4
                ...
                <a href="https://leetcode.com/poswalsameer/" target="_blank"><img src="leetcode.png" alt="" className='xl:bg-[#f0e2d3] xl:p-2 xl:rounded-xl xl:h-12 xl:w-12 xl:border-2 xl:border-[#f0e2d3] xl:transition-all xl:ease-in xl:delay-75 xl:hover:scale-110 xl:hover:cursor-none xl:mx-4
                ...
                <a href="https://twitter.com/sameerposwal03" target="_blank"><img src="twitter.png" alt="" className='xl:bg-[#f0e2d3] xl:p-2 xl:rounded-xl xl:h-12 xl:w-12 xl:border-2 xl:border-[#f0e2d3] xl:transition-all xl:ease-in xl:delay-75 xl:hover:scale-110 xl:hover:cursor-none xl:mx-4
                ...
                <a href="https://www.linkedin.com/in/sameerposwal/" target="_blank"><img src="linkedin.png" alt="" className='xl:bg-[#f0e2d3] xl:p-2 xl:rounded-xl xl:h-12 xl:w-12 xl:border-2 xl:border-[#f0e2d3] xl:transition-all xl:ease-in xl:delay-75 xl:hover:scale-110 xl:hover:cursor-none xl:mx-4
                
                2xl:bg-[#f0e2d3] 2xl:p-2 2xl:rounded-xl 2xl:h-12 2xl:w-12 2xl:border-2 2xl:border-[#f0e2d3] 2xl:mx-4 2xl:transition-all 2xl:ease-in 2xl:hover:scale-110 2xl:hover:cursor-none'/></a>
            </div>

            <a href="SameerPoswalResume.pdf" download>
                <button className='xl:h-12 xl:w-44 xl:flex xl:flex-row xl:justify-center xl:items-center xl:font-bold xl:text-lg xl:text-black xl:bg-[#c3a995] xl:rounded-xl xl:-ml-1 xl:my-12 xl:transition-all xl:ease-in xl:hover:bg-[#f0e2d3] xl:hover:text-black xl:hover:border-2 xl:hover:border-[#fefae0] xl:hover:cursor-none
